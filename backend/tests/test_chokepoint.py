...
outside AegisAI calls a registered tool's implementation. If this test ever
...
ALLOWED_CALLERS = {AEGIS_ROOT / "aegisai" / "core.py"}


def test_only_aegisai_core_calls_tool_fn():
    offenders = []
    ...
    assert offenders == [], f"Found direct tool execution outside AegisAI.guard: {offenders}"
